...
package com.database.pumpkin.config;



import com.database.pumpkin.common.http.EnumStatus;
...
public class Swagger2Configuration {
    //api接口包扫描路径
    public static final String SWAGGER_SCAN_BASE_PACKAGE = "com.database.pumpkin";
